  ...
  function(e, t) {
    !(function() {
      ...
      const s = 100,
        ...
        d = [0, 1].map(e =>
          twgl.createProgramInfo(c, [vInitParticles, fInitParticles(e)])
        ),
        g = [0, 1].map(e =>
      ...
      !(function e(t) {
        ...
        (n = t / 100),
          ...
          c.viewport(0, 0, c.canvas.clientWidth, c.canvas.clientHeight),
          (b = [h, h1]),
          (N = s / c.canvas.width),
          (T = n - H),
          (H = n),
          ...
          [0, 1].forEach(e => {
            c.useProgram(g[e].program),
              ...
              twgl.setUniforms(g[e], {
                ...
                logo_center: [
                  0.5 - 0.05 * (i[0] - 0.5 + 0.3 * Math.sin((3 * n) / 50)),
                  h2 - 0.05 * (i[1] - 0.5 + 0.3 * Math.sin((2 * n) / 50))
                ],
                logo_size: b.map(e => e * 0.5),
                mouse_pos: i,
                mouse_radius: N,
